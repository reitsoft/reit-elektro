...
<div class="grid grid-cols-12 gap-4">
			...
			<Table shadow>
				...
				<TableBody tableBodyClass="divide-y">
					{#each categories as { id, name, description, anzahl }}
						<TableBodyRow>
							<TableBodyCell
								><P class="font-semibold" size="lg" color="text-gray-500 dark:text-gray-400"
									>{name}</P
								></TableBodyCell
							>
								...
								<div class="flex justify-end">
									<ButtonGroup>
										<form method="POST" action="?/delete&id={id}">
											<Button outline color="yellow" href={`categories/${id}`}
												><EditOutline /></Button
											>
	...
	<div class="col-span-4">
		<Heading class="mb-8" customSize="text-2xl font-semibold">Neue Kategorie</Heading>
